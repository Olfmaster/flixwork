...
export default function AbschlussCTA({
  kontaktHref = "#anfrage",
  kontaktLabel = "Kontakt aufnehmen",
  titel = "Wie können wir Sie unterstützen?",
  text = "Wählen Sie Ihren Bereich oder sprechen Sie uns direkt an — wir melden uns persönlich und unverbindlich bei Ihnen.",
  telefon = null, // z. B. "+49 561 1234567" — rendert einen Anruf-Button
}) {
  const telHref = telefon ? `tel:${telefon.replace(/[^\d+]/g, "")}` : null;
  return (
    <section className="bg-white py-16 md:py-20">
      <div className="mx-auto max-w-7xl px-5 md:px-8">
        <div className="flx-hero-bg overflow-hidden rounded-3xl px-6 py-14 text-center text-white shadow-xl shadow-navy/10 md:px-12 md:py-16">
          ...
          <p className="mx-auto mt-4 max-w-xl leading-relaxed text-white/75">{text}</p>
