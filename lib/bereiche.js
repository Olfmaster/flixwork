...
export const bereiche = {
  logistik: {
    ...
    // KPI-Schlagwort-Band im Hero statt "Typische Positionen"-Panel (Website-Review 03.07.2026)
    band: ["95 % Besetzungsquote", "24 h Reaktionszeit", "48 h Ersatzgestellung", "< 5 % Frühfluktuation", "> 90 % Qualifikations-Match", "100 % Arbeitssicherheit"],
  ...
  industrie: {
    ...
    // Branchen-Spezialisierungen als Schlagwort-Band im Hero (Website-Review 03.07.2026)
    band: ["Automotive", "Kunststoffindustrie", "Chemieindustrie", "Rüstungsindustrie", "Metallindustrie"],
    cta: { label: "Personal anfragen", href: "#anfrage" },
  },
  handwerk: {
    slug: "handwerk",
    ...
    // Flixmonteure-Logo im Header vorbereitet (Website-Review 03.07.2026) —
    // finale Umsetzung hängt von Abstimmung mit dem bestehenden Webdesigner ab.
    navbarZusatzLogo: { src: "/flix-lmonteure.png", alt: "Flixmonteure" },
  },
};
